...
while (my $a=<A>){
   ...
   print B "deeparg short_reads_pipeline --forward_pe_file $dir/$a.R1.fastq --reverse_pe_file $dir/$a.R2.fastq --output_file $rstD/$a.deeparg -d /fs/project/PYS0226/pg123/deepargDatabase/ --bowtie_16s_identity 100 1>$rstD/$a.deeparg.out 2>$rstD/$a.deeparg.err\n";
